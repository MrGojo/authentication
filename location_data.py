STATES_AND_DISTRICTS = {
        ...
        "Karnataka": [
            "Bagalkote", "Bangalore Rural", "Bangalore Urban", "Belagavi", "Bellary", 
        ...
        "Nagaland": [
            "Chumukedima", "Dimapur", "Kiphire", "Kohima", 
            "Longleng", "Mokokchung", "Mon", "Noklak", 
        ...
        "Odisha": [
            ...
            "Kandhamal", "Kendrapara", "Kendujhar (Keonjhar)", "Khordha", 
        ...
        "Punjab": [
            ...
            "Mansa", "Moga", "Muktsar", "Nawanshahr (Shaheed Bhagat Singh Nagar)", 
            "Pathankot", "Patiala", "Rupnagar (Ropar)", "Sangrur", 
         ...
         "Rajasthan": [
            ...
            "Dungarpur", "Hanumangarh", "Jaipur", "Jaisalmer", 
            "Jalore", "Jhalawar", "Jhunjhunu", "Jodhpur", 
    ...
    "Uttar Pradesh": [
        ...
        "Meerut", "Mirzapur", "Moradabad", "Muzaffarnagar", "Raebareli", 
    ...
    "West Bengal": [
        ...
        "North 24 Parganas", "North Dinajpur", "Paschim Bardhaman", "Paschim Medinipur", 
        "Purba Bardhaman", "Purba Medinipur", "Purulia", "South 24 Parganas", 
        "South Dinajpur", "Uttar Dinajpur"
    ]
}

# Get list of states
STATES_LIST = list(STATES_AND_DISTRICTS.keys()) 